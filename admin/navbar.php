        ...
        <section class="sidebar" style="height:auto;">
           ...
           <ul class="sidebar-menu">
            ...
            <li><a href="#"><i class='fa fa-user'></i> <span>Registrar</span> <i class="fa fa-angle-left pull-right"></i></a>
              ...
              <ul class="treeview-menu">
                <li><a href="visitantes.php"><i class=""></i> Visitante Registrado</a></li>
                <li><a href="tramites.php"><i class=""></i> Trámites Registrado</a></li>
                <li><a href="realizarP.php"><i class=""></i> Asignar Pase</a></li>
                <li><a href="registrado.php"><i class=""></i> Asignado</a></li>
                </ul>
                </li>
...
<li><a href="#"><i class='fa fa-file-text-o'></i> <span>Reportes</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="listaV.php"><i class=""></i> Visitantes </a></li>
                <li><a href="listaT.php"><i class=""></i> Trámites </a></li>
                </ul>
                </li>

            
            <li><a href="#"><i class='fa fa-cog'></i> <span>Administracion</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="usuarios.php">Usuarios</a></li>
                <li><a href="departamentos.php">Departamentos</a></li>
                <li><a href="tramite.php">Trámites</a></li>
              </ul>
            </li>

            <li><a href="control.php"><i class=''></i> <span>Control</span></a></li>
