...
?>
  ...
  <div class="col-md-12">
                       ...
                       <form action="modal/insertarTra.php" method="POST" rol="form">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input class="form-control" id="cedula" name="fecha_tra" value="<?php date_default_timezone_set('America/Caracas'); echo date("d-m-Y");?>" require></input>
                          </div>
                       ...
                       <label for="requisitos">Requisitos</label>
                            <textarea name="requisitos_id" id="requisitos" class="form-control" cols=4 rows=4 maxlength=250 required="" >
                            </textarea>
                          </div>
